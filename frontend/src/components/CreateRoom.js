...
function CreateRoom({
	...
	const renderCreateBtn = () => {
		return (
			<>
				<Grid>
					<Button color="primary" variant="contained" onClick={handleRoomBtnPresses}>
						Create A Room
					</Button>
				</Grid>
				<Grid>
	...
	const renderUpdateBtn = () => {
		return (
			<Grid>
				<Button color="primary" variant="contained" onClick={handleUpdateRoomBtnPress}>
					Update Room
				</Button>
			</Grid>
		);
		...
		<Grid
			...
			<Grid>
				<FormControl component="fieldset">
					<FormHelperText>
						<span style={{ alignItems: "center" }}>Guest Control of Playback State</span>
					</FormHelperText>
					<RadioGroup
						row
			...
			<Grid>
				<FormControl>
					...
					/>
					<FormHelperText>
						<span style={{ alignItems: "center" }}>Votes Required To Skip Song</span>
					</FormHelperText>
				</FormControl>
			</Grid>
